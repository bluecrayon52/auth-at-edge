...
function isInvalidRefreshRequest(currentNonce, originalNonce, idToken, accessToken, refreshToken) {
...
export const handler = async (event) => {
    ...
    return {
        ...
        headers: Object.assign({ 'location': [{
                ...
                }], 'set-cookie': getCookieHeaders(clientId, oauthScopes, tokens, domainName, cookieSettings) }, cloudFrontHeaders)
    };
};
