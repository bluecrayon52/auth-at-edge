...
import { getConfig, extractAndParseCookies, decodeToken } from '../shared/app';
...
const { clientId, oauthScopes, cognitoAuthDomain, redirectPathSignIn, redirectPathAuthRefresh, tokenIssuer, tokenJwksUri, cookieSettings, cloudFrontHeaders } = getConfig();
    ...
    try {
        ...
        if ((Date.now() / 1000) - 60 > exp && refreshToken) {
            return {
                ...
                headers: Object.assign({ 'location': [{
                            key: 'location',
